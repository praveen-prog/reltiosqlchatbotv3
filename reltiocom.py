...
def get_reltio_data(unique_end_point):
...
#Insert into SQL DB
def sql_db_insert(unique_end_point):
   try:
       # Environment variables for credentials and endpoints
...
def execute_workflow():
    try:
        ...
        for unique_end_point in patient_data_endpoints:
            ...
            get_reltio_data(unique_end_point)
            extract_attributes()
            flatten_data_process()
            sql_db_insert(unique_end_point)
